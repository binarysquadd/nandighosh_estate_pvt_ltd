...
export default function TasksBoard({ project }: { project: any }) {
  // ✅ normalize all possibly string fields
  const approvals = toList(project?.approvals);
  const pendingTasks = toList(project?.pendingTasks);
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">
            {project?.progress ?? 0}% of project tasks completed
          </p>
        </div>
